...
$stmt = $pdo->query("SELECT * FROM products WHERE status IS NULL");
...
<div class="container-fluid px-0">
  <div class="pending-title mb-4">
    <i class="bi bi-hourglass-split"></i> Pending Products for Testing
  </div>
        ...
        <tbody>
          <?php foreach ($products as $p): ?>
            <tr>
              ...
              <td>
                <a href="test_voltage.php?product_id=<?= $p['id'] ?>" class="btn btn-primary btn-sm">Test</a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>
